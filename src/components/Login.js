...
const Login = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-100">
      <div className="flex shadow- rounded-lg bg-white overflow-hidden w-full max-w-4xl" style={{
    boxShadow: "0px 4px 20px rgba(255, 0, 150, 0.4), 0px 6px 30px rgba(0, 255, 150, 0.4)",
  }}>
        {/* Left Section */}
