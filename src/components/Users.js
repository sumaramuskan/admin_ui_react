...
const Users = ({ userData = [] }) => {
    ...
    const cardsData1 = [
        {
          title: 'Revenue',
          data: [200, 300, 400,200,122,543,222,1234,554,333,222,22,700,650,800], // Example data
          interval: 'Monthly',
          trend: 'up',
          value: '$12,000',
        },
        {
          title: 'User Growth',
          data: [10, 12, 14,200, 300, 400,200,122,543,222,1234,554,333,222,22,700,650,800], // Example data
          interval: 'Weekly',
          trend: 'neutral',
          value: '15%',
        },
        {
          title: 'Sales',
          data: [500, 600, 700,200, 300, 400,200,122,543,222,1234,554,333,222,22,700,650,800], // Example data
          interval: 'Quarterly',
          trend: 'down',
          value: '$8,000',
        },
