...
const Sidebar = () => {
  return (
    <>
      <aside
        className={` hidden w-64 bg-sidebar_bg z-2 md:block min-h-screen sticky`}
      >
        ...
        <nav class="text-sm text-black">
          <ul class="flex flex-col">
            ...
            <li class="px-4 text-lg hover:text-s6 hover:bg-white">
              {/* TODO: USE ONLY ONE TAG <a> or <Link> */}
        ...
        <div class="py-3 text-xl text-center tracking-widest bg-sidebar_bg border-b-2 hover:text-s6 hover:bg-white">
          <a
            href="/"
            class="py-3  flex items-center text-black rounded-lg justify-center absolute bottom-4 left-16"
          >
